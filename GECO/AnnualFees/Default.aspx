    ...
    <div style="max-width: 950px;">
        ...
        <p style="text-align: center;">
            ...
            <asp:DropDownList ID="ddlFeeYear" runat="server" CausesValidation="False" AutoPostBack="true"
                ForeColor="DarkRed" Font-Bold="true" /><br />
            <br />
            <asp:HyperLink ID="linkInvoice" Text="PRINT INVOICE" Visible="false" runat="server"
                Target="_blank" CssClass="linkHighlightButton" Font-Bold="true" />
            <asp:Label ID="lblDeadline" ForeColor="DarkRed" Font-Bold="true" runat="server" Visible="false"></asp:Label>
        </p>
        <p>
            ...
            <act:TabPanel runat="Server" ID="Welcome" HeaderText="Welcome">
                <ContentTemplate>
                    ...
                    <p>
                        ...
                        so using the 
                        <%--<a href="FeeAmendment.xls" download>Fee Amendment Form</a>.--%>
                        Fee Amendment Form. 
                        <br /><em>The Fee Amendment Form is being revised and will be available soon.</em>
                    </p>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="RegsChecklist" runat="server">
                        <p>
                            ...
                            (minimum annual fee
                            <asp:Label ID="lblPart70MinFeeRate" runat="server"></asp:Label>)
                        </p>
                        <p>
                            <asp:CheckBox ID="chkSmSource" runat="server" Text="Synthetic Minor Source" Enabled="false" />
                            (annual fee
                            <asp:Label ID="lblSmFeeRate" runat="server"></asp:Label>)
                        </p>
                    </asp:Panel>
                    ...
                    <p>
                        ...
                        <asp:Label ID="lblNspsFeeRate" runat="server"></asp:Label>
                        will apply. However, if the source is subject to NSPS but exempt from the NSPS fee for all NSPS equipment
                        at the facility in accordance with Section 2.1 of the manual, check the box for NSPS Exempt and select the 
                        reasons why it is exempt.                   
                    </p>
                    <table class="table-simple table-list">
                        <tr>
                            <th scope="col">Current status:</th>
