<%@ Page Language="VB" MasterPageFile="tn.master" AutoEventWireup="false"
    Inherits="GECO.TN_Default" Title="GECO - ISMP Test Notification" Codebehind="Default.aspx.vb" %>
            ...
            <h1>Performance Test Notifications</h1>
                ...
                <asp:Panel ID="pnlDetails" runat="server" Width="100%" Visible="False">
                    <div style="text-align: left">
                        <span style="font-size: 12pt"><strong>Details for Selected Test Notification:</strong></span>
                        <table style="width: 100%">
                            <tr>
                                <td align="center">
                                    <asp:Label ID="lblTestPlan" runat="server" Font-Bold="True" Font-Names="Verdana"
                                        Font-Size="Medium" ForeColor="Red" Text="Remember to submit Test Plan if not yet done."></asp:Label></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
