...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <tr>
                <td align="left" valign="top">The Emissions Statement is required to be completed by facilities located in the
                    ...
                    <ul>
                        ...
                        <li><span style="font-family: Verdana">Actual annual emissions of VOCs and/or NOx are
                                    greater than 25 tons per year.*
                                    <br />
                            <br />
                            The basis for this requirement is Georgia Rule for Air Quality Control 391-3-1-.02(6)(a)4.</span></li>
                    </ul>
                </td>
            </tr>
            <tr>
    ...
    <asp:Panel ID="pnlCurrentES" runat="server" Font-Size="Small">
    ...
    <asp:Panel ID="pnlPastES" runat="server" Font-Size="Small">
        <table align="center" cellspacing="1" style="width: 100%">
            <tr>
                <td>&nbsp;&nbsp;
                </td>
