...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <p>
        ...
        <asp:RegularExpressionValidator ID="Regex3" runat="server" Display="Dynamic"
            ControlToValidate="txtPwd" ErrorMessage="Password is too short (minimum of 12 characters)." ValidationGroup="confirmPasswordRequirements"
            ValidationExpression="^[a-zA-Z0-9]{12,}$" ForeColor="red" />
        <asp:CustomValidator runat="server" ID="passwordRequirements" ControlToValidate="txtPwd" ClientValidationFunction="validatePassword"
            ForeColor="red" ValidateEmptyText="true" ValidationGroup="confirmPasswordRequirements" Display="Dynamic" ErrorMessage="This text will be changed later."> </asp:CustomValidator>
        <br />
