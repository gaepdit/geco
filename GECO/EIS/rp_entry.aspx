...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    ...
    <acs:ModalUpdateProgress ID="ModalUpdateProgress1" runat="server" DisplayAfter="0"
        ...
        <ProgressTemplate>
            <div class="modalPopup">
                <img src="<%= Page.ResolveUrl("~/assets/images/progressbar_green.gif") %>" alt="Working..." align="middle" /><br />
    ...
    <asp:Panel ID="pnlFacilityEdit" runat="server">
        ...
        <div class="fieldwrapper">
            ...
            <asp:RequiredFieldValidator ID="reqvMailingAddressStateCode" ControlToValidate="ddlFacility_StateMail"
        ...
        <div class="fieldwrapper">
            ...
            <asp:TextBox ID="TxtMailingAddressComment" runat="server" CssClass="editable" TextMode="MultiLine" Rows="4"
        ...
        <div class="fieldwrapper">
            ...
            <asp:CustomValidator ID="cusvNAICSCode" runat="server" ControlToValidate="txtNAICSCode"
        ...
        <div class="fieldwrapper">
            ...
            <div style="display: inline-block">
                <asp:TextBox ID="txtFacilitySiteComment" runat="server" class="editable" TextMode="MultiLine" onKeyUp="javascript:Count(this);"
                    Text="" Width="400px" Rows="4"></asp:TextBox>
        ...
        <div class="fieldwrapper">
            ...
            <asp:TextBox ID="txtPrefix" runat="server" class="editable" Text="" Width="108px" Height="21px" MaxLength="15"></asp:TextBox>
    ...
    <asp:Panel ID="pnlNAICSCodeLookup" BackColor="#ffffff" runat="server" BorderColor="#333399"
        ...
        <table border="0" cellpadding="2" cellspacing="1" width="100%">
            ...
            <tr>
                <td align="center" colspan="2" class="style4">&nbsp;<asp:Label ID="lblNAICSMessage" runat="server" CssClass="label" Text="After clicking this button, the SCC code will be prefilled with the selection."></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="reqvNAICS" runat="server"
                        ControlToValidate="txtSelectedNAICSCode" ValidationGroup="vgNAICS">*Search and select a code or select Cancel to enter code manually.</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td align="center" colspan="2">&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="pnlMap" runat="server" Style="display: none" BackColor="#507CD1">
